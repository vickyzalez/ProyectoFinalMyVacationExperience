...
import com.wikitude.samples.advanced.ArchitectViewExtensionActivity;
...
import static com.wikitude.samples.util.DefaultConfigs.DEFAULT_CAMERA_2_ENABLED;
        ...
        try {
            ...
            for (int i = 0; i < categoryArray.length(); i++) {
                ...
                for (int u = 0; u < samplesArray.length(); u++) {
                    ...
                    } else if ((features & ArchitectStartupConfiguration.Features.Geo) == ArchitectStartupConfiguration.Features.Geo) {
